...
def test_the_router_builds_one_vendor_entry_carrying_both_keys(monkeypatch):
    monkeypatch.setattr("app.llm.router.settings.LLM_DEFAULT_PROVIDER", "openai")
    monkeypatch.setattr("app.llm.router.settings.OPENAI_API_KEY", "key1")
    monkeypatch.setattr("app.llm.router.settings.OPENAI_API_KEY_2", "key2")
    monkeypatch.setattr("app.llm.router.settings.GOOGLE_AI_API_KEY", None)
    monkeypatch.setattr("app.llm.router.settings.GOOGLE_AI_API_KEY_2", None)
